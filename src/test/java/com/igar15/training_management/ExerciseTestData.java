...
public class ExerciseTestData {
    ...
    public static final Exercise USER1_WORKOUT1_EXERCISE1 = new Exercise(USER1_WORKOUT1_EXERCISE1_ID, 90);
    public static final Exercise USER1_WORKOUT1_EXERCISE2 = new Exercise(USER1_WORKOUT1_EXERCISE2_ID, 30);
    public static final Exercise USER1_WORKOUT1_EXERCISE3 = new Exercise(USER1_WORKOUT1_EXERCISE3_ID, 5);
    ...
    public static Exercise getUpdatedExercise() {
        return new Exercise(USER1_WORKOUT1_EXERCISE1_ID, 25);
    }
}
